...
allennlp train "hdygie_config/${config_name}-pretrain.jsonnet" \
    --serialization-dir "models/${config_name}-pretrain" \
    --include-package dygie

allennlp train "hdygie_config/${config_name}.jsonnet" \
